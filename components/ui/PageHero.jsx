    ...
    <div className="relative bg-brand-navy overflow-hidden pt-32 pb-16">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
        <FadeIn>
          ...
          <h1 className="font-display text-4xl font-semibold tracking-tight text-white [text-wrap:balance] sm:text-5xl">
            {title}
          </h1>
          {subtitle && (
            <p className="mt-5 text-xl text-white/60 max-w-xl leading-relaxed font-light">
              {subtitle}
            </p>
          )}
        </FadeIn>
